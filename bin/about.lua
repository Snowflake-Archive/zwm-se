...
local function render()
  ...
  term.write(title)
  drawRow("Version", ("%s (%d)"):format(registry.readKey("machine", "SystemVersionName"), registry.readKey("machine", "SystemVersionNumber")), 3, w - 3)
  drawRow("Version Date", ("%s"):format(registry.readKey("machine", "SystemVersionDate")), 4, w - 3)
